...
import json
stop_words=[]
json_embedding_tf_idf=open("/home/subinay/Documents/data/pairwise_similarity/tf_idf/tf_idf_embedding_50docs_1.json")
embedding= json.load(json_embedding_tf_idf)
dir_test="/home/subinay/Documents/data/pairwise_similarity/Third_50/50_docs/"
test_docs=os.listdir(dir_test)
sec_sim=[]
content_sim=[]
with open("/home/subinay/Documents/data/pairwise_similarity/Fourth_50/section_similarity_T_50.txt","r") as f2:
    for line in f2:
        line=line.strip()
        line=line.split()
...
def doc_sim(docid1,docid2): # compute similarity b/w two documents using cosine similarity
    ...
    score=cosine_similarity(doc1_embedding,doc2_embedding)
...
def sim_test_docs():
    ...
    for i in range(0,50):
        for j in range(i+1,50):
            ...
            sim_score=0.6*float(sim_score)+0.4*float(sec_sim[count])
            count=count+1
